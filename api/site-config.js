// Função serverless Vercel: proxy read-only de site_config, sem expor
// nenhuma chave do Supabase ao navegador.
...
module.exports = async (req, res) => {
  ...
  try {
    const r = await fetch(`${SB_URL}/rest/v1/site_config?select=key,value`, { headers: serviceHeaders });
